...
Partial Public Class Database1DataSet1
    ...
    Partial Public Class tblitemsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddtblitemsRow(ByVal itemname As String, ByVal qty As Decimal, ByVal price As Decimal, ByVal category As String, ByVal serial_no As String, ByVal stock_in As Date, ByVal stock_out As String, ByVal item_description As String) As tblitemsRow
            Dim rowtblitemsRow As tblitemsRow = CType(Me.NewRow,tblitemsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, itemname, qty, price, category, serial_no, stock_in, stock_out, item_description}
        ...
        Private Sub InitClass()
            ...
            Me.columnstock_in = New Global.System.Data.DataColumn("stock_in", GetType(Date), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class tblitemsRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property stock_in() As Date
            Get
                Try 
                    Return CType(Me(Me.tabletblitems.stock_inColumn),Date)
                Catch e As Global.System.InvalidCastException
...
Namespace Database1DataSet1TableAdapters
    ...
    Partial Public Class tblitemsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [tblitems] ([itemname], [qty], [price], [category], [item_description"& _ 
                "], [serial_no], [stock_in], [stock_out]) VALUES (@itemname, @qty, @price, @categ"& _ 
                "ory, @item_description, @serial_no, @stock_in, @stock_out)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@qty", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "qty", Global.System.Data.DataRowVersion.Current, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@stock_in", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "stock_in", Global.System.Data.DataRowVersion.Current, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [tblitems] SET [itemname] = @itemname, [qty] = @qty, [price] = @price, [ca"& _ 
                "tegory] = @category, [item_description] = @item_description, [serial_no] = @seri"& _ 
                "al_no, [stock_in] = @stock_in, [stock_out] = @stock_out WHERE (([id] = @Original"& _ 
                "_id))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@qty", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "qty", Global.System.Data.DataRowVersion.Current, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@stock_in", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "stock_in", Global.System.Data.DataRowVersion.Current, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, itemname, qty, price, category, item_description, serial_no, stock_in,"& _ 
                " stock_out FROM tblitems"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT id, itemname, qty, price, category, item_description, serial_no, stock_in,"& _ 
                " stock_out FROM tblitems WHERE (itemname LIKE @Param1)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet1.tblitemsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet1.tblitemsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet1.tblitemsDataTable = New Database1DataSet1.tblitemsDataTable()
        ...
        Public Overloads Overridable Function Search(ByVal dataTable As Database1DataSet1.tblitemsDataTable, ByVal Param1 As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal Param1 As String) As Database1DataSet1.tblitemsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Param1 Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database1DataSet1.tblitemsDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal itemname As String, ByVal qty As String, ByVal price As Global.System.Nullable(Of Decimal), ByVal category As String, ByVal item_description As String, ByVal serial_no As String, ByVal stock_in As Global.System.Nullable(Of Date), ByVal stock_out As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(serial_no,String)
            End If
            If (stock_in.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(6).Value = CType(stock_in.Value,Date)
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(stock_out,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal itemname As String, ByVal qty As String, ByVal price As Global.System.Nullable(Of Decimal), ByVal category As String, ByVal item_description As String, ByVal serial_no As String, ByVal stock_in As Global.System.Nullable(Of Date), ByVal stock_out As String, ByVal Original_id As Integer) As Integer
            If (itemname Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(qty,String)
            End If
            If (price.HasValue = true) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(serial_no,String)
            End If
            If (stock_in.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(stock_in.Value,Date)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(stock_out,String)
            End If
    ...
    Partial Public Class tblusersTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)> _
        Public Overridable Overloads Function Fill(ByVal dataTable As Database1DataSet1.tblusersDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = True) Then
                dataTable.Clear()
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], True)> _
        Public Overridable Overloads Function GetData() As Database1DataSet1.tblusersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet1.tblusersDataTable = New Database1DataSet1.tblusersDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As Database1DataSet1.tblusersDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
